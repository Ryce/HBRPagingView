#
#  Be sure to run `pod spec lint HBRPagingView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Ryce"
  # s.authors            = { "Ryce" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/Ryce"
  ...
  s.source       = { :git => "https://github.com/Ryce/HBRPagingView.git", :tag => "0.1.0" }
  ...
  s.source_files  = "Classes", "HBRPagingView/**/*.swift"
